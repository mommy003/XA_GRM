...
50        continue
          ...
          do vi=1,tn
            ...
            !print*,'vg x ve:',idum+xi,tn+nb*k-nb+xi,tmpm(1,1)
          end do !vi
    ...
    do k=1,mn
      do xi=1,m_tnk(ii,k)    !check
        do i=1,pedn
          ...
          write(46,'(i3,i3,i3,i7,100f24.16)')ii,k,xi,i,blup_r(i,sum(m_tnk(1:ii,k))-m_tnk(ii,k)+xi,k)  !check
        end do
      end do
    end do
  end do
