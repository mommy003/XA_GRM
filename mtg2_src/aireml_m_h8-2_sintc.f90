...
subroutine aireml_m_h2_dsgn3 (mbin,yidx,yv,rn,rnm,trn,pedn,tn,fnm,tfn,mn,fl4,fl5,fl11,fl11r,fl24,xmm,nit,conv,wt_res,fl_dsgn,cov_idx)
...
double precision::LC,LA,LG,ypy,x1,x2,x3,x10,x11,v1,v2,v3,v10,v11,v22,v222
      ...
      do xi=1,tn
        ...
        do i=1,rnm(xi)
          ...
          do yi=1,tn
            trny=trny+rnm(yi)
            do j=1,rnm(yi)
              v1=v1+vcva(4,vi,yi)*zm2(dsgn2(yi,j,1),zi)*pm(trny-rnm(yi)+j,trnx-rnm(xi)+i)
            end do
          end do
          v2=v2+v1*vcva(4,vi,xi)*zm2(zi,dsgn2(xi,i,1))
        end do
      end do
      !blup_mee_r(zi,vi)=v2
