...
implicit none
  ...
  real::p_case_s12,p_case_s12_,estim_OR2,estim_OR3,r2_se
...
!print*,thd,zv
  ...
  !print*,r2*cv/(1+r2*theta*cv),Q_r2,(2-2*Q_r2**.5)*.5
  !print*,(2-2*Q_r2**.5)**.5,(2-2*r2**.5)**.5     !check

  r2_se=(2-2*r2**.5)**.5

   !#auc from (r2*h2o2*cv2), i.e. r2 (0,1) on the liability scale
   v102=r2*h2o2*cv2
   !v102=(r2-2*r2_se)*h2o2*cv2  !check what is this r2
